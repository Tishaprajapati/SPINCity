...
CREATE TABLE `inventory` (
  ...
  `item_type` enum('Spare Parts','Safety Equipment','Maintenance Tools','Accessories','Consumables') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `inventory_ibfk_1` FOREIGN KEY (`station_id`) REFERENCES `station` (`station_id`) ON DELETE CASCADE ON UPDATE CASCADE,
